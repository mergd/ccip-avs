...
import (
	...
	"github.com/mergd/ccip-avs/challenger/mocks"
	chtypes "github.com/mergd/ccip-avs/challenger/types"
...
func TestCallChallengeModule(t *testing.T) {
	...
	challenger.tasks[TASK_INDEX] = cstaskmanager.IIncredibleLendingTaskManagerTask{
...
func TestProcessTaskResponseLog(t *testing.T) {
	...
	taskResponseLog := cstaskmanager.ContractIncredibleLendingTaskManagerTaskResponded{
