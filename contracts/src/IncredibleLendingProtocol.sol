...
import "./IncredibleLendingTaskManager.sol";
...
contract IncredibleLendingProtocol is ReadHandler, Lender {
    ...
    function setTaskManager(IncredibleLendingTaskManager _taskManager) external {
    ...
    function createLoanCallback(bytes calldata data, bytes calldata extraData) public {
        ...
        coordinator.createLoan(address(this), debtToken, collateralToken, collateralAmt, debtAmt, 0, 0, 0, data);
    }
