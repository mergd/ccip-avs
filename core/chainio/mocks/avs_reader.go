...
// Source: github.com/mergd/ccip-avs/core/chainio (interfaces: AvsReaderer)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/avs_reader.go -package=mocks github.com/mergd/ccip-avs/core/chainio AvsReaderer
//
...
import (
	...
	contractERC20Mock "github.com/mergd/ccip-avs/contracts/bindings/ERC20Mock"
...
func (m *MockAvsReaderer) CheckSignatures(arg0 context.Context, arg1 [32]byte, arg2 []byte, arg3 uint32, arg4 contractIncredibleLendingTaskManager.IBLSSignatureCheckerNonSignerStakesAndSignature) (contractIncredibleLendingTaskManager.IBLSSignatureCheckerQuorumStakeTotals, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckSignatures", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(contractIncredibleLendingTaskManager.IBLSSignatureCheckerQuorumStakeTotals)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
