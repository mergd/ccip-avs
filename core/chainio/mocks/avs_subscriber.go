...
// Source: github.com/mergd/ccip-avs/core/chainio (interfaces: AvsSubscriberer)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/avs_subscriber.go -package=mocks github.com/mergd/ccip-avs/core/chainio AvsSubscriberer
//
...
func (m *MockAvsSubscriberer) ParseTaskResponded(arg0 types.Log) (*contractIncredibleLendingTaskManager.ContractIncredibleLendingTaskManagerTaskResponded, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseTaskResponded", arg0)
	ret0, _ := ret[0].(*contractIncredibleLendingTaskManager.ContractIncredibleLendingTaskManagerTaskResponded)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAvsSubscriberer) SubscribeToNewTasks(arg0 chan *contractIncredibleLendingTaskManager.ContractIncredibleLendingTaskManagerNewTaskCreated) event.Subscription {
	m.ctrl.T.Helper()
...
func (m *MockAvsSubscriberer) SubscribeToTaskResponses(arg0 chan *contractIncredibleLendingTaskManager.ContractIncredibleLendingTaskManagerTaskResponded) event.Subscription {
	m.ctrl.T.Helper()
