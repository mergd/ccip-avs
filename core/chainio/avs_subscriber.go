...
type AvsSubscriberer interface {
	SubscribeToNewTasks(newTaskCreatedChan chan *cstaskmanager.ContractIncredibleLendingTaskManagerNewTaskCreated) event.Subscription
	SubscribeToTaskResponses(taskResponseLogs chan *cstaskmanager.ContractIncredibleLendingTaskManagerTaskResponded) event.Subscription
	ParseTaskResponded(rawLog types.Log) (*cstaskmanager.ContractIncredibleLendingTaskManagerTaskResponded, error)
}
...
func NewAvsSubscriberFromConfig(config *config.Config) (*AvsSubscriber, error) {
	return NewAvsSubscriber(
		config.IncredibleLendingServiceManagerAddr,
...
func (s *AvsSubscriber) SubscribeToNewTasks(newTaskCreatedChan chan *cstaskmanager.ContractIncredibleLendingTaskManagerNewTaskCreated) event.Subscription {
...
func (s *AvsSubscriber) SubscribeToTaskResponses(taskResponseChan chan *cstaskmanager.ContractIncredibleLendingTaskManagerTaskResponded) event.Subscription {
...
func (s *AvsSubscriber) ParseTaskResponded(rawLog types.Log) (*cstaskmanager.ContractIncredibleLendingTaskManagerTaskResponded, error) {
	return s.AvsContractBindings.TaskManager.ContractIncredibleLendingTaskManagerFilterer.ParseTaskResponded(rawLog)
}
