...
// this hardcodes abi.encode() for cstaskmanager.IIncredibleLendingTaskManagerTaskResponse
// unclear why abigen doesn't provide this out of the box...
func AbiEncodeTaskResponse(h *cstaskmanager.IIncredibleLendingTaskManagerTaskResponse) ([]byte, error) {

	// The order here has to match the field ordering of cstaskmanager.IIncredibleLendingTaskManagerTaskResponse
...
func GetTaskResponseDigest(h *cstaskmanager.IIncredibleLendingTaskManagerTaskResponse) ([32]byte, error) {
